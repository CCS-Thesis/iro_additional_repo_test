...
'''------------------------------------
asrdfyghjkvgcxdszrtghjbnvcxzdsfghbnvcxdfghjbnvcxdfghbn vcxgfhbn vghbn vcxgvb
------------------------------------'''
...
def calc_distances(sound_file):
    ...
    SECONDS_UNTIL_NEXT_BARK_SEQUENCE = 1
...
for s in samples:
    ...
    # y_reduced_centroid_mb is not the noise reduced file
    
    # calc_distances(y_reduced_centroid_mb, sr, filename)
    

# do calc_distances here (probably) with 
